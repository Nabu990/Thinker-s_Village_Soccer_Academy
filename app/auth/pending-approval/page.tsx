      ...
      >
        <Card className="shadow-2xl bg-white/90 backdrop-blur-sm border border-emerald-100">
          <CardHeader className="pb-6 text-center sm:pb-8">
            <motion.div 
              className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 shadow-lg sm:mb-6 sm:h-20 sm:w-20"
              initial={{ scale: 0.9 }}
              animate={{ scale: 1 }}
